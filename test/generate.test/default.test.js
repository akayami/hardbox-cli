...
describe('Generate Command', () => {
	it('Default output validation', () => {
		...
		expect(o).to.have.property('name').equal('name');
		expect(o).to.have.property('vhost').to.be.an('object');
		expect(o.vhost).to.have.property('protocol').equal('http');
		expect(o.vhost).to.have.property('domain').equal('domain.local');
		expect(o.vhost).to.have.property('port').equal('80');
		expect(o.vhost).to.have.property('pathname').equal('/');
	});
